...
Y = '\x1b[1;34m'
print()
token=input('\033[2;32m[+] \x1b[38;5;209mTOKEN : \033[2;35m')
print('\n')
...
def KONAN():
    ...
    try:
        ...
        exit(f'''\n{M}File %s لم يتم العثور علي ملف بهاذا الاسم''' % fileX)
